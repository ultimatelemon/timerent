<template>
  <div>
    <div class="mb-12 flex justify-between">
      <div>
        <div class="font-semibold text-xl">Reserveringen</div>
        <div class="text-base leading-6 text-gray-900">Beheer hier alle reserveringen</div>
      </div>
      <div>
      ...
      <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tr v-if="reservations.length > 0" v-for="reservation in reservations" :key="reservation.id" class="even:bg-gray-50 hover:bg-gray-100 hover:cursor-pointer" @click="this.$router.push({name: 'application.reservations.edit', params: {reservation: reservation.id}})">
