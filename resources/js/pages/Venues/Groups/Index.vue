  ...
  <div>
    <div class="mb-12 flex justify-between">
      <div>
        ...
        <div class="text-sm">Beheer hier de groepen voor je members</div>
      </div>
      <div>
...
<!--              <td class="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900">{{ unit.tax_percentage }}%</td>-->
            ...
            <tr v-else class="text-center">
              <td colspan="3" class="pt-12">Er zijn nog geen groepen aangemaakt of zoekopdracht niet gevonden</td>
            </tr>
            </tbody>
          </table>
          <div v-if="pagination">
