<template>
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Login op Timerent</h2>
    </div>
...
<!--              <router-link :to='{name: "password.reset.request"}' class="font-semibold text-indigo-600 hover:text-indigo-500">Wachtwoord vergeten?</router-link>-->
        ...
        <div class="text-center text-sm text-gray-500">
          <router-link :to="{name: 'password-forgot'}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Wachtwoord vergeten?</router-link>
        </div>
      </div>
